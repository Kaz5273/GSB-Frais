...
public class PraticiensActivity extends AppCompatActivity {
    ...
    {
        Praticien praticien = levisiteur.getLespraticiens().get(unInt);
        return praticien;
    }
                        ...
                        for(String unPraticien : levisiteur.getListpraticiens()){
                            ...
                            call1.enqueue(new Callback<Praticien>() {
                                ...
                                public void onResponse(Call<Praticien> call1, Response<Praticien> response) {
                                    ...
                                    recyclerView.addOnItemTouchListener(new RecyclerTouchListener(PraticiensActivity.this, recyclerView, new RecylcerviewClickListener() {
                                        @Override
                                        public void onClick(View view, int position) {
                                            Intent myIntent = new Intent(PraticiensActivity.this, VisitesActivity.class);
                                            myIntent.putExtra("token", token);
                                            myIntent.putExtra("idPraticien", getCurrentPraticien(position).getId().toString());
                                            setIntent(myIntent);
